...
export interface SignatureMint1155 extends BaseContract {
    ...
    functions: {
        ...
        mintTo(_to: string, _uri: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        isApprovedForAll(account: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
        isTrustedForwarder(forwarder: string, overrides?: CallOverrides): Promise<boolean>;
        mintTo(_to: string, _uri: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
