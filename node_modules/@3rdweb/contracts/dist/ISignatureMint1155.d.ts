...
export interface ISignatureMint1155 extends BaseContract {
    ...
    functions: {
        mintTo(to: string, uri: string, amount: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        mintTo(to: string, uri: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
